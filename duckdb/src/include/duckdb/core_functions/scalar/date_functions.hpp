...
struct TryStrpTimeFun {
	...
	static constexpr const char *Parameters = "text,format";
	static constexpr const char *Description = "Converts string to timestamp using the format string (timestamp with "
	                                           "time zone if %Z is specified). Returns NULL on failure";
	static constexpr const char *Example =
